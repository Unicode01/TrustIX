      ...
      {activeSection === "performance" && (
        <section className="config-section">
          ...
          <div className="form-grid">
            ...
            <SelectField label={props.t("tls_data_plane", "TLS data plane")} help={props.t("help_transport_policy_tls_data_plane", "auto negotiates the TrustIX encrypted data plane after TLS authentication; full_tls keeps TLS records for all stream data.")} value={cfg.transport_policy?.tls_data_plane || ""} options={["", "auto", "full_tls"]} onChange={(value) => props.onDesired({ ...cfg, transport_policy: { ...(cfg.transport_policy || {}), tls_data_plane: value } })} />
