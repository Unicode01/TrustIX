...
func TestKernelDistroSupportUsesCurrentProductionEvidenceBoundary(t *testing.T) {
	...
	for _, want := range []string{
		...
		"requires zero",
		"`replay_old` drops and bounds",
		"`replay_seen/open` plus total secure-direct drop ratios",
		"minimum received throughput was 2.975477 Gbps",
		"minimum received throughput was\n7.515116 Gbps",
		"throughput of 11.819391 Gbps",
		"`8c2eebccbcf031f0133c8dbf192d826526c5187c`",
		"per-direction throughput of 5.424119 Gbps A-to-B and 5.561685 Gbps",
		"This is a dedicated",
