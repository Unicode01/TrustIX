...
run_gate() {
  ...
  set -- "$@" --require-binary-identity --require-stable-boot-id --require-uname-artifacts --min-uname-nodes 2 --require-iperf-pair-directions --require-kernel-log-artifacts --min-kernel-log-nodes 2
