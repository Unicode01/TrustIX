...
func TestCrossHostProductionGateRequiresFastPathArtifacts(t *testing.T) {
	...
	for _, want := range []string{
		...
		"--require-module-param-min trustix_datapath.enable_features=3200",
		"--require-module-param-min trustix_datapath.features=3200",
		"--require-module-param-min trustix_datapath.safe_features=3200",
...
func TestCrossHostProductionGateUsesPerCaseMinGbps(t *testing.T) {
	...
	requireArgPair("expfull", "--require-module-param-min", "trustix_datapath.enable_features=3200")
	requireArgPair("expfull", "--require-module-param-min", "trustix_datapath.features=3200")
	requireArgPair("expfull", "--require-module-param-min", "trustix_datapath.safe_features=3200")
