...
const (
	...
	FeatureTIXTCPPortSharding            = "tix_tcp_port_sharding"
	FeatureSecureTIXTCPFullDatapath      = "secure_tix_tcp_full_datapath"
	FeatureSecureInnerTCPChecksumPartial = "secure_inner_tcp_checksum_partial"
